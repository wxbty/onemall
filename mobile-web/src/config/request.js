...
const serviceRouter = function(requestUrl) {
  function getConfig() {
    const configDev = {
      '/order-api': {
        prefix: '/order-api',
        target: 'http://114.55.38.162:18088/order-api',
      },
      '/user-api': {
        prefix: '/user-api',
        target: 'http://114.55.38.162:18082/user-api',
      },
      '/product-api': {
        prefix: '/product-api',
        target: 'http://114.55.38.162:18081/product-api',
      },
      '/promotion-api': {
        prefix: '/promotion-api',
        target: 'http://114.55.38.162:18085/promotion-api',
      },
      '/pay-api': {
        prefix: '/pay-api',
        target: 'http://114.55.38.162:18084/pay-api',
      },
      '/search-api': {
        prefix: '/search-api',
        target: 'http://114.55.38.162:18086/search-api',
      },
    };
